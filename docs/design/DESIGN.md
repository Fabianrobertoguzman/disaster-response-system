...
- **Database-generated IDs (§2.4).** Every entity table has a `BIGINT
  AUTO_INCREMENT` surrogate primary key generated by MySQL — the deliberate
  exception is the `incident_responders` junction, whose composite key
  (`incident_id`, `responder_id`) of two such generated IDs is itself the
